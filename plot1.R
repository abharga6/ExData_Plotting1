...
#Opening png device, plotting 1st plot and closing the png device
png(file="plot1.png")
hist(data$Global_active_power, col = "red", ylab = "Frequency", xlab = "Global Active Power (killowatts)", main ="Global Active Power")
dev.off()
